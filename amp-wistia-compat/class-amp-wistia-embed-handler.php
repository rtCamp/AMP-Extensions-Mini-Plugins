<?php
/**
 * Class AMP_Wistia_Embed_Handler
 *
 * @package AMP
 */
...
class AMP_Wistia_Embed_Handler extends AMP_Base_Embed_Handler {
	 ...
	 * Tag.
	 *
	 * @var string AMP amp-wistia-player tag
	 */
	private $amp_tag = 'amp-wistia-player';
	...
	public function oembed( $matches, $attr, $url ) {
		return $this->render( [ 'data_media_hashed_id' => $url ] );
	}
